      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden relative">
        ...
        <div className="p-8 bg-slate-50 text-center border-t border-slate-100 flex flex-col space-y-4">
          ...
          <div className="pt-4 border-t border-slate-200">
            <p className="text-slate-400 text-[10px] font-black Proper Case tracking-widest leading-relaxed">
              Tim Reaksi Cepat (TRC)<br />BPBD Kabupaten Kulon Progo<br />Dikembangkan oleh<br /> Adi Agus Prihartanto,S.Kom
            </p>
          </div>
        </div>
      </div>
